package com.abhi.objectdector.utils
...
class Draw(context: Context?,var rect: Rect, var text: String) : View(context){
    ...
    lateinit var boundryPaint: Paint
    ...
    private fun init(){
        boundryPaint = Paint()
        boundryPaint.color = Color.BLACK
    ...
    override fun onDraw(canvas: Canvas?) {
        ...
        canvas?.drawRect(rect.left.toFloat(),rect.top.toFloat(),rect.right.toFloat(),rect.bottom.toFloat(),boundryPaint)
    }
}